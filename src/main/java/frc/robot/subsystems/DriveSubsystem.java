...
public class DriveSubsystem extends SubsystemBase 
{
    ...
    {       
      m_states =
        ...
        SwerveDriveKinematics.desaturateWheelSpeeds(m_states, SwerveDriveModuleConstants.k_MaxSpeed);
    ...
    {
        m_odometry.resetPosition(pose, Rotation2d.fromDegrees(optimizeAngle()));
    }
